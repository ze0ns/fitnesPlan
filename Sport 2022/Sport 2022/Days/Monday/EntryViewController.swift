...
class EntryViewController: UIViewController,UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        if planDayLocalDB.count > 0 {
            ...
            traningLabel1.text = planDayLocalDB[0].exer.name
            ...
            traningLabel2.text = planDayLocalDB[1].exer.name
            ...
            traningLabel3.text = planDayLocalDB[2].exer.name
            ...
            traningLabel4.text = planDayLocalDB[3].exer.name
            ...
            traningLabel5.text = planDayLocalDB[4].exer.name
            ...
            traningLabel6.text = planDayLocalDB[5].exer.name
...
//    }
    ...
    @objc func saveTraining(){
        ...
        let ExId0: Int = planDayLocalDB[0].exer.id
        ...
        let ExId1: Int = planDayLocalDB[1].exer.id
        ...
        let ExId2: Int = planDayLocalDB[2].exer.id
        ...
        let ExId3: Int = planDayLocalDB[3].exer.id
        ...
        let ExId4: Int = planDayLocalDB[4].exer.id
        ...
        let ExId5: Int = planDayLocalDB[5].exer.id
