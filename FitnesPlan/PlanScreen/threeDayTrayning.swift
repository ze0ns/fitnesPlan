...
//        let ExId0: Int = planDayLocalDB[12].exer.name
...
//        let ExId1: Int = planDayLocalDB[13].ExerciseProfiles.name
...
//        let ExId2: Int = planDayLocalDB[14].ExerciseProfiles.name
...
//        let ExId3: Int = planDayLocalDB[15].ExerciseProfiles.name
...
//        let ExId4: Int = planDayLocalDB[16].Exer.name
...
//        let ExId5: Int = planDayLocalDB[17].Exer.name
